...
<div class="cont-box type1 mt--standard">
    <ol class="bu-list--num type1">
        ...
        <li><em class="num">3</em> 각 탭메뉴에 제어 대상을 명시하기 위해 <code>aria-controls</code> 속성을 기입해주고, 탭패널에 <code>aria-controls</code> 속성값과 동일한 id값을 기입해주어 탭메뉴와 탭패널을 의미적으로 연결시켜준다.</li>
        <li><em class="num">4</em> 각 탭패널에 <code>role="tabpanel"</code>을 선언, 탭패널 역할 부여.</li>
    </ol>
</div>
