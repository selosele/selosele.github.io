...
tags:
    ...
    - inline-table
---
CSS로 가로정렬하는 방법하면 떠오르는 것들 : float, inline-block 등등.. 그와중에 inline-table이라는 신기한 녀석을 발견하여 기록하고자 함. block formatting context인 table을 말 그대로 inline fomatting context의 성질을 갖게 만듦. 예제 코드를 봅시다.
