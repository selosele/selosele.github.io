...
{% include image.html url='/assets/images/post/theme02_img01.png' description='개편 전 테마. 포스트 목록에 글 밖에 없어서 뭔가 답답함을 유발한다.' alt='' %}
...
{% include image.html url='/assets/images/post/theme02_img02.png' description='개편 후 테마. 이미지를 추가하여 가독성을 향상시켰다.' alt='' %}
